plotLine <- function(design_gaps_List){
  ...
  for(datID in 1:length(design_gaps_List[[1]])){
    ...
    legend(x=5.2, y=mean(mean_AUCgaps), legend=rownames(mean_AUCgaps),
